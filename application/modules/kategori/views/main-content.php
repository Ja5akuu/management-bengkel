                            ...
                            <tbody>
                                ...
                                foreach ($allkategori as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url().'kategori/edit/'.$data->id_kategori.'';?>" class="btn btn-success" >
                                                EDIT
                                            </a> &nbsp
                                            <a href="<?php echo base_url().'kategori/delete/'.$data->id_kategori.'';?>" class="btn btn-danger" onClick="return confirmDialog()">
                                                DELETE
                                            </a>
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('kategori/addkategori');?>
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="id_kategori" value="<?php echo $kodeotomatis ;?>">
                            </div>
