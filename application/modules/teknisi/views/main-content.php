                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Master Teknisi</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="zero_config" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php
                                foreach ($allteknisi as $data) {
                                    ?>
                                    <tr>
                                        <td><?php echo $data->id_teknisi ?></td>
                                        <td><?php echo $data->teknisi ?></td>
                                        <td>
                                            <a href="<?php echo base_url().'teknisi/edit/'.$data->id_teknisi.'';?>" class="btn btn-success" >
                                                EDIT
                                            </a> &nbsp
                                            <a href="<?php echo base_url().'teknisi/delete/'.$data->id_teknisi.'';?>" class="btn btn-danger" onClick="return confirmDialog()">
                                                DELETE
                                            </a>
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('teknisi/addteknisi');?>
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="id_teknisi" value="<?php echo $kodeotomatis ;?>">
                            </div>
