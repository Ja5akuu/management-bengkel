                            ...
                            <tbody>
                                ...
                                foreach ($allcustomer as $data) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url().'customer/edit/'.$data->id_customer.'';?>" class="btn btn-success" >
                                                EDIT
                                            </a> &nbsp
                                            <a href="<?php echo base_url().'customer/delete/'.$data->id_customer.'';?>" class="btn btn-danger" onClick="return confirmDialog()">
                                                DELETE
                                            </a>
                                        </td>
                                    </tr>
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="id_customer" value="<?php echo $kodeotomatis ;?>">
                            </div>
                        ...
                        <!-- end -->
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="hp" placeholder="ex : 085715490668">
                            </div>
