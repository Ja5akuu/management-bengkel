    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Form Edit type</h4>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    { 
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo base_url() ?>type/update">
                           <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  name="id_type" value="<?php echo $data->id_type ?>" readonly>
                            </div>
